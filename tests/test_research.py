...
from sable import (RowStore, ColumnStore, HybridStore, SegmentStore, VectorizedExecutor, JoinExecutor,
                   ...
                   HotWarmColdStore, BufferPolicy, SchemaMetadata)
...
class ResearchFeatureTests(unittest.TestCase):
    ...
    def test_bounded_bandit_with_confidence_intervals(self):
        ...
        bandit = BoundedUCB1Bandit(["arm1", "arm2"], exploration_cap=2.0, decay_rate=0.99)
        arm = bandit.select()
    ...
    def test_hot_warm_cold_store(self):
        ...
        # Classify some data
        rows = [{"price": 100, "access_freq": 0.8}, {"price": 50, "access_freq": 0.2}, {"price": 200, "access_freq": 0.1}]
    ...
    def test_buffer_policy(self):
        ...
        decision = policy.choose("scans", 0.6)  # High scan ratio should favor sequential
